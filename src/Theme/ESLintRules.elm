...
viewRuleLink : String -> Element msg
viewRuleLink eslintName =
    link [ Font.bold ]
        { url = "https://eslint.org/docs/latest/rules/" ++ eslintName
        , label = text eslintName
        }

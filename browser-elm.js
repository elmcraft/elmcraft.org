...
var $author$project$Pages$Internal$Platform$NoOp = {$: 'NoOp'};
...
var $author$project$Pages$Internal$Platform$ContentJson = F2(
	function (staticData, is404) {
		return {is404: is404, staticData: staticData};
	});
var $elm$json$Json$Decode$bool = _Json_decodeBool;
var $author$project$RequestsAndPending$decoder = $elm$json$Json$Decode$dict(
	A2($elm$json$Json$Decode$map, $elm$core$Maybe$Just, $elm$json$Json$Decode$string));
var $author$project$Pages$Internal$Platform$contentJsonDecoder = A3(
	$elm$json$Json$Decode$map2,
...
var $author$project$TerminalText$Cyan = {$: 'Cyan'};
var $author$project$TerminalText$Style = F2(
	function (a, b) {
		return {$: 'Style', a: a, b: b};
	});
var $author$project$TerminalText$cyan = function (inner) {
	return A2($author$project$TerminalText$Style, $author$project$TerminalText$Cyan, inner);
};
var $author$project$TerminalText$RawText = function (a) {
	return {$: 'RawText', a: a};
};
var $author$project$TerminalText$text = function (value) {
	return $author$project$TerminalText$RawText(value);
};
var $elm$core$String$toUpper = _String_toUpper;
var $author$project$BuildError$banner = function (title) {
	return _List_fromArray(
		[
			$author$project$TerminalText$cyan(
...
var $author$project$TerminalText$colorToString = function (color) {
	return $author$project$TerminalText$ansi(
		function () {
			switch (color.$) {
				case 'Red':
					return '[31m';
...
var $author$project$TerminalText$toString_ = function (textValue) {
	if (textValue.$ === 'RawText') {
		var content = textValue.a;
		return content;
	} else {
		var color = textValue.a;
		var innerText = textValue.b;
		return $elm$core$String$concat(
			_List_fromArray(
				[
					$author$project$TerminalText$colorToString(color),
					$author$project$TerminalText$toString_(innerText),
...
var $author$project$TerminalText$toString = function (list) {
	return A2(
		$elm$core$String$join,
		'',
		A2($elm$core$List$map, $author$project$TerminalText$toString_, list));
};
var $author$project$BuildError$errorToString = function (error) {
	return $author$project$TerminalText$toString(
		_Utils_ap(
			$author$project$BuildError$banner(error.title),
			error.message));
};
...
var $author$project$Pages$ContentCache$ContentJson = F2(
	function (staticData, is404) {
		return {is404: is404, staticData: staticData};
	});
var $author$project$Pages$ContentCache$contentJsonDecoder = A3(
	$elm$json$Json$Decode$map2,
				...
				if (entry.$ === 'Just') {
					...
					return $elm$core$Maybe$Just(
						$author$project$Pages$ContentCache$Parsed(
							{is404: rawContent.is404, staticData: rawContent.staticData}));
				}
			},
			cache);
	});
			...
			return A2(
				...
				function (downloadedContent) {
					return _Utils_Tuple3(
						urls.currentUrl,
						downloadedContent,
						A3($author$project$Pages$ContentCache$update, cache, urls, downloadedContent));
				},
...
var $author$project$Pages$StaticHttpRequest$toBuildError = F2(
	function (path, error) {
		switch (error.$) {
		...
		A2(
			...
			A2(
				...
				$author$project$Pages$Internal$String$chopForwardSlashes(
					A2(
						$elm$core$String$dropLeft,
						$elm$core$String$length(urls.baseUrl.path),
...
var $author$project$Pages$Internal$Platform$init = F4(
	function (config, flags, url, key) {
		...
		if (_v0.$ === 'Just') {
			...
			var sharedDataResult = A2(
				$elm$core$Result$mapError,
				$author$project$Pages$StaticHttpRequest$toBuildError(url.path),
				A3($author$project$Pages$StaticHttpRequest$resolve, $author$project$Pages$Internal$ApplicationType$Browser, config.sharedData, justContentJson));
			var pagePath = $author$project$Pages$Internal$Platform$urlsToPagePath(urls);
			var pageDataResult = A2(
				$elm$core$Result$mapError,
				$author$project$Pages$StaticHttpRequest$toBuildError(url.path),
				A3(
					$author$project$Pages$StaticHttpRequest$resolve,
					$author$project$Pages$Internal$ApplicationType$Browser,
					config.data(
			...
			if (_v1.$ === 'Ok') {
				...
				var pageData = _v2.b;
				var userFlags = $author$project$Pages$Flags$BrowserFlags(
					A2(
				...
				return _Utils_Tuple2(
					{
						...
						pageData: $elm$core$Result$Err(
							$author$project$BuildError$errorToString(error)),
						url: url
					},
					$elm$core$Platform$Cmd$none);
			}
...
var $author$project$Pages$ContentCache$is404 = F2(
	function (dict, urls) {
		return A2(
			$elm$core$Maybe$withDefault,
			true,
...
var $author$project$Pages$Internal$Platform$update = F3(
	function (config, appMsg, model) {
		switch (appMsg.$) {
			...
			case 'HotReloadComplete':
				...
				var was404 = A2($author$project$Pages$ContentCache$is404, model.contentCache, urls);
				var sharedDataResult = A2(
					$elm$core$Result$mapError,
					$author$project$Pages$StaticHttpRequest$toBuildError(model.url.path),
					A3($author$project$Pages$StaticHttpRequest$resolve, $author$project$Pages$Internal$ApplicationType$Browser, config.sharedData, contentJson.staticData));
				var pageDataResult = A2(
					$elm$core$Result$mapError,
					$author$project$Pages$StaticHttpRequest$toBuildError(model.url.path),
					A3(
				...
				var _v13 = A3($elm$core$Result$map2, $elm$core$Tuple$pair, sharedDataResult, pageDataResult);
				if (_v13.$ === 'Ok') {
					var _v14 = _v13.a;
					var sharedData = _v14.a;
					var pageData = _v14.b;
										...
										config.onPageChange(
											{
												...
												path: A2($author$project$Pages$Internal$Platform$urlToPagePath, model.url, model.baseUrl),
...
var $author$project$Pages$Internal$Platform$mainView = F2(
	function (config, model) {
		var urls = {baseUrl: model.baseUrl, currentUrl: model.url};
		if (A2($author$project$Pages$ContentCache$is404, model.contentCache, urls)) {
			return {
				body: A2(
					$elm$html$Html$div,
					_List_Nil,
			...
			if (_v0.$ === 'Ok') {
				...
				return A3(
					config.view,
					{
						...
						path: $author$project$Pages$PagePath$build(
							$author$project$Pages$ContentCache$pathForUrl(urls))
					},
					pageData.sharedData,
...
var $author$project$Pages$Internal$Platform$view = F2(
	function (config, model) {
		var _v0 = A2($author$project$Pages$Internal$Platform$mainView, config, model);
		var title = _v0.title;
		var body = _v0.body;
		return {
	...
	return $elm$browser$Browser$application(
		{
			init: F3(
				function (flags, url, key) {
					return A4($author$project$Pages$Internal$Platform$init, config, flags, url, key);
				}),
			onUrlChange: $author$project$Pages$Internal$Platform$UrlChanged,
			onUrlRequest: $author$project$Pages$Internal$Platform$LinkClicked,
							...
							[
								...
								function (decodeValue) {
									...
									if (_v1.$ === 'Ok') {
										...
										return $author$project$Pages$Internal$Platform$HotReloadComplete(contentJson);
									} else {
										return $author$project$Pages$Internal$Platform$NoOp;
									}
								},
								config.fromJsPort)
							]));
			...
			update: $author$project$Pages$Internal$Platform$update(config),
			view: $author$project$Pages$Internal$Platform$view(config)
		});
};
...
var $author$project$Site$data = $author$project$DataSource$succeed(_Utils_Tuple0);
...
var $author$project$Pages$Manifest$usEnglish = A2(
...
var $author$project$Pages$Manifest$init = function (options) {
	return {backgroundColor: $elm$core$Maybe$Nothing, categories: _List_Nil, description: options.description, displayMode: $author$project$Pages$Manifest$Standalone, iarcRatingId: $elm$core$Maybe$Nothing, icons: options.icons, lang: $author$project$Pages$Manifest$usEnglish, name: options.name, orientation: $author$project$Pages$Manifest$Portrait, shortName: $elm$core$Maybe$Nothing, startUrl: options.startUrl, themeColor: $elm$core$Maybe$Nothing};
};
var $author$project$Site$manifest = function (_static) {
	return $author$project$Pages$Manifest$init(
		{
...
var $author$project$Site$config = function (_v0) {
	return {canonicalUrl: 'https://elm-pages.com', data: $author$project$Site$data, head: $author$project$Site$head, manifest: $author$project$Site$manifest};
};
...
var $author$project$DataSource$map = F2(
						...
						function (appType, rawResponses) {
							return A2(
								...
								function (_v2) {
									...
									return _Utils_Tuple2(
										partiallyStripped,
										A2($author$project$DataSource$map, fn, nextRequest));
								},
...
var $author$project$Page$buildNoState = F2(
	function (_v0, builderState) {
		...
		return {
			...
			update: F5(
				function (_v7, _v8, _v9, _v10, _v11) {
...
var $author$project$Page$Index$data = $author$project$DataSource$succeed(_Utils_Tuple0);
...
var $author$project$Page$singleRoute = function (_v0) {
	var data = _v0.data;
	var head = _v0.head;
	return $author$project$Page$WithData(
		{
			...
			handleRoute: function (_v2) {
				return $author$project$DataSource$succeed(true);
			},
			head: head,
			serverless: false,
			staticRoutes: $author$project$DataSource$succeed(
				_List_fromArray(
					[
						{}
					]))
...
var $author$project$Page$Index$view = function (_static) {
	return {
		body: _List_fromArray(
			[
				$elm$html$Html$text('Hey there!')
			]),
		title: 'Hi!'
	};
};
var $author$project$Page$Index$page = A2(
	...
	$author$project$Page$singleRoute(
...
var $author$project$TemplateModulesBeta$dataForRoute = function (route) {
	if (route.$ === 'Nothing') {
		return $author$project$DataSource$succeed($author$project$TemplateModulesBeta$Data404NotFoundPage____);
	} else {
		var routeParams = route.a.a;
		return A2(
			$author$project$DataSource$map,
			$author$project$TemplateModulesBeta$DataIndex,
			$author$project$Page$Index$page.data(routeParams));
	}
};
var $author$project$TemplateModulesBeta$fromJsPort = _Platform_incomingPort('fromJsPort', $elm$json$Json$Decode$value);
var $author$project$Route$Index = function (a) {
	return {$: 'Index', a: a};
};
...
var $author$project$DataSource$combineReducedDicts = F2(
...
var $author$project$DataSource$map2 = F3(
					...
					function (appType, rawResponses) {
						...
						if (_v3.a.$ === 'Ok') {
							if (_v3.b.$ === 'Ok') {
								...
								return $elm$core$Result$Ok(
									_Utils_Tuple2(
										A2($author$project$DataSource$combineReducedDicts, newDict1, newDict2),
										A3($author$project$DataSource$map2, fn, newValue1, newValue2)));
							} else {
								var error = _v3.b.a;
								return $elm$core$Result$Err(error);
							}
								...
								return A2(
									...
									function (_v7) {
										...
										return _Utils_Tuple2(
											dict1,
											A3(
												$author$project$DataSource$map2,
												fn,
												value1,
...
var $author$project$DataSource$combine = A2(
	$elm$core$List$foldl,
	$author$project$DataSource$map2($elm$core$List$cons),
	$author$project$DataSource$succeed(_List_Nil));
var $author$project$TemplateModulesBeta$getStaticRoutes = A2(
	...
	A2(
		$author$project$DataSource$map,
		$elm$core$List$concat,
		$author$project$DataSource$combine(
			_List_fromArray(
				[
					A2(
					$author$project$DataSource$map,
					$elm$core$List$map($author$project$Route$Index),
...
var $author$project$TemplateModulesBeta$handleRoute = function (maybeRoute) {
	if (maybeRoute.$ === 'Nothing') {
		return $author$project$DataSource$succeed(false);
	} else {
		var routeParams = maybeRoute.a.a;
		return $author$project$Page$Index$page.handleRoute(routeParams);
	}
};
...
var $author$project$Shared$data = $author$project$DataSource$succeed(_Utils_Tuple0);
...
var $author$project$Shared$template = {
	...
	sharedMsg: $author$project$Shared$SharedMsg,
			...
			var _v1 = _Utils_Tuple2(
				A3(
					...
					A2(
						...
						maybePagePath)),
				pageData);
			if ((_v1.a.$ === 'Just') && (_v1.b.$ === 'DataIndex')) {
				var _v2 = _v1.a.a;
				var routeParams = _v2.a.a;
				var justPath = _v2.b;
				var thisPageData = _v1.b.a;
				return A3(
...
var $author$project$DataSource$addUrls = F2(
...
var $author$project$DataSource$lookupHelp = F4(
		...
		if (requestInfo.$ === 'Request') {
			...
			return A2(
				...
				function (_v2) {
					...
					var nextRequest = _v2.b;
					return A4(
						$author$project$DataSource$lookupHelp,
						A2($elm$core$Dict$union, strippedResponses, strippedSoFar),
						appType,
						A2($author$project$DataSource$addUrls, urls, nextRequest),
						rawResponses);
				},
				A2(lookupFn, appType, rawResponses));
		} else {
...
var $author$project$DataSource$lookup = $author$project$DataSource$lookupHelp($elm$core$Dict$empty);
...
var $author$project$DataSource$andThen = F2(
	function (fn, requestInfo) {
		return $author$project$Pages$StaticHttpRequest$Request(
			_Utils_Tuple2(
				$author$project$DataSource$lookupUrls(requestInfo),
				F2(
					function (appType, rawResponses) {
						return function (result) {
							...
							A3($author$project$DataSource$lookup, appType, requestInfo, rawResponses));
					})));
	});
var $author$project$ApiRoute$Handler = F4(
	function (a, b, c, d) {
		return {$: 'Handler', a: a, b: b, c: c, d: d};
	});
var $author$project$ApiRoute$literal = F2(
	function (segment, _v0) {
		...
		return A4(
			$author$project$ApiRoute$Handler,
...
var $author$project$ApiRoute$pathToMatches = F2(
	function (path, _v0) {
		var pattern = _v0.a;
		var handler = _v0.b;
		var toString = _v0.c;
...
var $author$project$ApiRoute$tryMatch = F2(
	function (path, _v0) {
		var pattern = _v0.a;
		var handler = _v0.b;
		var toString = _v0.c;
...
var $author$project$ApiRoute$buildTimeRoutes = F2(
	function (buildUrls, fullHandler) {
		var pattern = fullHandler.a;
		var handler = fullHandler.b;
		...
		return {
			...
			handleRoute: function (path) {
				var matches = A2($author$project$ApiRoute$pathToMatches, path, fullHandler);
				return A2(
					$author$project$DataSource$map,
			...
			matchesToResponse: function (path) {
				...
				var routeFound = A2(
					...
					preBuiltMatches);
				return A2(
					$author$project$DataSource$andThen,
					function (found) {
						return found ? A2(
							$elm$core$Maybe$withDefault,
							$author$project$DataSource$succeed($elm$core$Maybe$Nothing),
							A2(
								$elm$core$Maybe$map,
								$author$project$DataSource$map($elm$core$Maybe$Just),
								A2($author$project$ApiRoute$tryMatch, path, fullHandler))) : $author$project$DataSource$succeed($elm$core$Maybe$Nothing);
					},
					routeFound);
			},
			regex: A2(
...
var $author$project$ApiRoute$singleRoute = function (handler) {
	return A2(
		$author$project$ApiRoute$buildTimeRoutes,
		function (constructor) {
			return $author$project$DataSource$succeed(
				_List_fromArray(
					[constructor]));
		},
		handler);
...
var $author$project$TemplateModulesBeta$manifestHandler = $author$project$ApiRoute$singleRoute(
	A2(
		$author$project$ApiRoute$literal,
		'manifest.json',
		$author$project$ApiRoute$succeed(
			A2(
				$author$project$DataSource$andThen,
					...
					return A2(
						...
						function (data) {
							return A2(
								...
								$author$project$Site$config(resolvedRoutes).canonicalUrl,
								$author$project$Site$config(resolvedRoutes).manifest(data));
						},
						$author$project$Site$config(resolvedRoutes).data);
				},
...
var $author$project$Api$routes = function (htmlToString) {
	return _List_Nil;
};
	...
	function (route, path, model) {
		...
		if ((_v0.a.$ === 'ModelIndex') && (_v0.b.$ === 'Just')) {
			...
			return A2(
				...
				A4($author$project$Page$Index$page.subscriptions, routeParams, path, templateModel, model.global));
		} else {
			return $elm$core$Platform$Sub$none;
		}
	});
var $author$project$TemplateModulesBeta$toJsPort = _Platform_outgoingPort('toJsPort', $elm$core$Basics$identity);
var $author$project$Pages$Flags$PreRenderFlags = {$: 'PreRenderFlags'};
			...
			case 'OnPageChange':
				...
				return function (_v2) {
					...
					A6(
						...
						$author$project$Pages$Flags$PreRenderFlags,
						sharedData,
						pageData,
						navigationKey,
						$elm$core$Maybe$Just(
						...
						return function (_v9) {
							...
							if (c.$ === 'Just') {
								...
								return _Utils_Tuple3(
									...
									A2(
										$author$project$Shared$template.update,
										$author$project$Shared$template.sharedMsg(sharedMsg),
										model.global));
							} else {
								return _Utils_Tuple3(
									a,
...
var $author$project$Router$ensureLeadingSlash = function (path) {
	return A2($elm$core$String$startsWith, '/', path) ? path : ('/' + path);
};
var $author$project$Router$stripTrailingSlash = function (path) {
	return (A2($elm$core$String$endsWith, '/', path) && ($elm$core$String$length(path) > 1)) ? A2($elm$core$String$dropRight, 1, path) : path;
};
var $author$project$Router$normalizePath = function (path) {
	return $author$project$Router$stripTrailingSlash(
		$author$project$Router$ensureLeadingSlash(path));
};
var $author$project$Router$toRegex = function (pattern) {
	return A2(
		$elm$core$Maybe$withDefault,
		$elm$regex$Regex$never,
		$elm$regex$Regex$fromString(pattern));
};
var $author$project$Router$submatches = F2(
...
var $author$project$Router$tryMatch = F2(
	function (_v0, path) {
		var pattern = _v0.pattern;
		var toRoute = _v0.toRoute;
		return toRoute(
			A2(
				$author$project$Router$submatches,
				pattern,
				$author$project$Router$normalizePath(path)));
	});
var $author$project$Router$firstMatch = F2(
		...
		return A2(
			...
			function (matcher) {
				return A2(
					...
					$author$project$Router$toRegex(matcher.pattern),
					$author$project$Router$normalizePath(path)) ? A2($author$project$Router$tryMatch, matcher, path) : $elm$core$Maybe$Nothing;
			},
			matchers);
	});
...
var $author$project$Route$urlToRoute = function (url) {
	return A2($author$project$Router$firstMatch, $author$project$Route$matchers, url.path);
};
...
var $author$project$TemplateModulesBeta$view = F3(
	function (page, globalData, pageData) {
		var _v0 = _Utils_Tuple2(page.frontmatter, pageData);
...
var $author$project$TemplateModulesBeta$main = $author$project$Pages$Internal$Platform$application(
	{
		apiRoutes: function (htmlToString) {
			return A2(
				...
				$author$project$Api$routes(htmlToString));
		},
...
_Platform_export({'TemplateModulesBeta':{'init':$author$project$TemplateModulesBeta$main($elm$json$Json$Decode$value)({"versions":{"elm":"0.19.1"},"types":{"message":"Pages.Internal.Platform.Msg TemplateModulesBeta.Msg","aliases":{"Pages.ContentCache.ContentCache":{"args":[],"type":"Dict.Dict Pages.ContentCache.Path Pages.ContentCache.Entry"},"Pages.Internal.Platform.ContentJson":{"args":[],"type":"{ staticData : RequestsAndPending.RequestsAndPending, is404 : Basics.Bool }"},"Page.Index.Msg":{"args":[],"type":"Basics.Never"},"Pages.ContentCache.Path":{"args":[],"type":"List.List String.String"},"RequestsAndPending.RequestsAndPending":{"args":[],"type":"Dict.Dict String.String (Maybe.Maybe String.String)"},"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"},"Pages.ContentCache.ContentJson":{"args":[],"type":"{ staticData : RequestsAndPending.RequestsAndPending, is404 : Basics.Bool }"}},"unions":{"Pages.Internal.Platform.Msg":{"args":["userMsg"],"tags":{"LinkClicked":["Browser.UrlRequest"],"UrlChanged":["Url.Url"],"UserMsg":["userMsg"],"UpdateCache":["Result.Result Http.Error ( Url.Url, Pages.Internal.Platform.ContentJson, Pages.ContentCache.ContentCache )"],"UpdateCacheAndUrl":["Url.Url","Result.Result Http.Error ( Url.Url, Pages.Internal.Platform.ContentJson, Pages.ContentCache.ContentCache )"],"PageScrollComplete":[],"HotReloadComplete":["Pages.Internal.Platform.ContentJson"],"NoOp":[]}},"TemplateModulesBeta.Msg":{"args":[],"tags":{"MsgGlobal":["Shared.Msg"],"OnPageChange":["{ path : Pages.PagePath.PagePath, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String, metadata : Maybe.Maybe Route.Route }"],"MsgIndex":["Page.Index.Msg"]}},"Basics.Bool":{"args":[],"tags":{"True":[],"False":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":[]}},"Pages.ContentCache.Entry":{"args":[],"tags":{"Parsed":["Pages.ContentCache.ContentJson"]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"List.List":{"args":["a"],"tags":{}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Shared.Msg":{"args":[],"tags":{"OnPageChange":["{ path : Pages.PagePath.PagePath, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"],"SharedMsg":["Shared.SharedMsg"]}},"Basics.Never":{"args":[],"tags":{"JustOneMore":["Basics.Never"]}},"Pages.PagePath.PagePath":{"args":[],"tags":{"Internal":["List.List String.String"],"External":["String.String"]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"Route.Route":{"args":[],"tags":{"Index":["{}"]}},"String.String":{"args":[],"tags":{"String":[]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}},"Dict.NColor":{"args":[],"tags":{"Red":[],"Black":[]}},"Shared.SharedMsg":{"args":[],"tags":{"NoOp":[]}}}}})}});}(this));